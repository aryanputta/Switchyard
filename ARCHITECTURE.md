...
Each phase ships a working baseline. No phase replaces retrieval research with a generic chatbot.
...
Reproducible repo, one-command demo, this architecture, frozen manifest, TREC results, ESCI results, ANN recall-vs-latency curve, Grafana dashboard, failure-fallback demo, limitations section, five-minute talk, and resume bullets containing measured values only.
